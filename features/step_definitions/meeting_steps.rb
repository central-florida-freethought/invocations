...
Given(/^a (\w+) speaker$/i) do |_religion_name|
...
When(/^I add a new meeting with an existing speaker$/) do
  ...
  fill_in 'Concerns', with: 'Bacon ipsum dolor sit amet cillum beef ribs biltong
    cow, chuck tongue prosciutto turkey aliqua tri-tip. Short loin aute
    frankfurter laboris qui tail. Ham hock voluptate t-bone shankle, rump minim
    chuck dolore.'
